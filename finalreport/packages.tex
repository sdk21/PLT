...
\lstdefinelanguage{qlang}{ %
  ...
  keywords={def,if,else,elif,for, from, to, by, while, break, continue, true, false, mat, int, comp, float},
  otherkeywords={@},
  morecomment=[l]{\#},
  classoffset=1,morekeywords={C,print,norm,trans,det,adj,conj,unit,im,re,sin,cos,tan,gt,lt,geq,leq,eq,neq,true,false,not,and,or,xor},keywordstyle=\bf\color{purple},classoffset=0,
}
\lstset{%
  language=qlang,
